...
PORTFOLIO_CONFIG = {
    ...
    'AFRM':      {'weight': 0.20, 'type': 'Long', 'currency': 'USD', 'country': 'USA'},
    'INPST.AS':  {'weight': 0.15, 'type': 'Long', 'currency': 'EUR', 'country': 'NLD'},
    'HARVIA.HE': {'weight': 0.15, 'type': 'Long', 'currency': 'EUR', 'country': 'FIN'},
    'BFT.WA':    {'weight': 0.15, 'type': 'Long', 'currency': 'PLN', 'country': 'POL'},
    'NBIS':      {'weight': 0.05, 'type': 'Long', 'currency': 'USD', 'country': 'USA'},
    'CDR.WA':    {'weight': 0.10, 'type': 'Long', 'currency': 'PLN', 'country': 'POL'},
    '3659.T':    {'weight': 0.05, 'type': 'Long', 'currency': 'JPY', 'country': 'JPN'},
    'XTB.WA':    {'weight': 0.10, 'type': 'Long', 'currency': 'PLN', 'country': 'POL'},
    'BRK-B':     {'weight': 0.10, 'type': 'Long', 'currency': 'USD', 'country': 'USA'},
    'EQT':       {'weight': 0.10, 'type': 'Long', 'currency': 'USD', 'country': 'USA'},
    'META':      {'weight': 0.10, 'type': 'Long', 'currency': 'USD', 'country': 'USA'},
    'PSKY':      {'weight': 0.05, 'type': 'Long', 'currency': 'USD', 'country': 'USA'},
    'SWM.WA':    {'weight': 0.05, 'type': 'Long', 'currency': 'PLN', 'country': 'POL'},
    'RBLX':      {'weight': 0.05, 'type': 'Long', 'currency': 'USD', 'country': 'USA'},
    'SNAP':      {'weight': 0.05, 'type': 'Long', 'currency': 'USD', 'country': 'USA'},
    'MU':        {'weight': 0.02, 'type': 'Long', 'currency': 'USD', 'country': 'USA'},
    '000660.KS': {'weight': 0.02, 'type': 'Long', 'currency': 'KRW', 'country': 'KOR'},

    # --- SHORT POSITIONS (70% Target) ---
    'MSFT':      {'weight': 0.20, 'type': 'Short', 'currency': 'USD', 'country': 'USA'},
    '7974.T':    {'weight': 0.10, 'type': 'Short', 'currency': 'JPY', 'country': 'JPN'},
    'JMT.LS':    {'weight': 0.075, 'type': 'Short', 'currency': 'EUR', 'country': 'PRT'},
    'CARL-B.CO': {'weight': 0.075, 'type': 'Short', 'currency': 'DKK', 'country': 'DNK'},
    'F':         {'weight': 0.075, 'type': 'Short', 'currency': 'USD', 'country': 'USA'},
    'ABI.BR':    {'weight': 0.075, 'type': 'Short', 'currency': 'EUR', 'country': 'BEL'},
    'BDX.WA':    {'weight': 0.05, 'type': 'Short', 'currency': 'PLN', 'country': 'POL'},
    'STLA':      {'weight': 0.05, 'type': 'Short', 'currency': 'USD', 'country': 'USA'},
}
